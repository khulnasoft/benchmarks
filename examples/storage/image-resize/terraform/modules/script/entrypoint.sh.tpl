...
make load \
  rampingduration="${rampingduration}" consecutiveduration="${consecutiveduration}" batchduration="${batchduration}" \
  requests="${requests}" startfrom="${startfrom}" conns="${conns}" batchsize="${batchsize}" \
