...
variable "base_uri" {
  description = "base_uri - khulnasoft project base uri"
  type        = string
  default     = "https://jjqwaskwktqjmyyuqrix.khulnasoft.red"
}
variable "conns" {
...
variable "batchsize" {
  description = "batchsize - batch size for the benchmark stage with batches"
  type        = string
  default     = "10"
}
...
variable "batchduration" {
  description = "batchduration - duration of the batch requests stage"
  type        = string
  default     = "20"
}
