...
const baseUri = __ENV.BASE_URI
  ? __ENV.BASE_URI
  : 'https://jjqwaskwktqjmyyuqrix.khulnasoft.red'
...
export default function () {
  ...
  // projects
  try {
    pw.goto('https://app.khulnasoft.com/')
  ...
  // project
  try {
    pw.goto('https://app.khulnasoft.com/project/gryakvuryfsrgjohzhbq')
  ...
  // editor
  try {
    pw.goto('https://app.khulnasoft.com/project/gryakvuryfsrgjohzhbq/editor')
  ...
  // api
  try {
    pw.goto('https://app.khulnasoft.com/project/gryakvuryfsrgjohzhbq/api')
